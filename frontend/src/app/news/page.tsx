        ...
        {(loading && filters.page === 1) || searchLoading || savedLoading || (!minLoadElapsed && filters.page === 1) ? (
          ...
          <div className="text-center py-16">
            <div className="relative inline-flex items-center justify-center mb-5">
              ...
              <div
                className="relative w-16 h-16 rounded-full bg-accent-red/10 border border-accent-red/20 flex items-center justify-center animate-float"
              >
          ...
          <div className="text-center py-16">
            {isSearching ? (
              ...
              <>
                <div
                  className="relative inline-flex items-center justify-center mb-5 animate-float"
                >
