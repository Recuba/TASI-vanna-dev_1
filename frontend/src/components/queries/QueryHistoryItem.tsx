...
function timeAgo(timestamp: number, t: (ar: string, en: string) => string): string {
  ...
  if (minutes < 60) return t(`\u0645\u0646\u0630 ${minutes} \u062F\u0642\u064A\u0642\u0629`, `${minutes}m ago`);
  const hours = Math.floor(minutes / 60);
  if (hours < 24) return t(`\u0645\u0646\u0630 ${hours} \u0633\u0627\u0639\u0629`, `${hours}h ago`);
  const days = Math.floor(hours / 24);
  if (days < 30) return t(`\u0645\u0646\u0630 ${days} \u064A\u0648\u0645`, `${days}d ago`);
    ...
    >
      ...
      >
        ...
        <svg
          ...
          className={cn(
            'flex-shrink-0 mt-0.5 text-[var(--text-muted)] transition-transform duration-200 rtl:rotate-180',
            expanded && 'rotate-90'
          )}
        >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 mt-1 text-xs text-[var(--text-muted)]">
            <span>{timeAgo(record.executedAt, t)}</span>
            <span>{record.executionTimeMs}ms</span>
            <span>{record.rowCount} {t('\u0635\u0641', 'rows')}</span>
            {record.name && (
        ...
        <button
          ...
          aria-label={record.isFavorite ? t('\u0625\u0632\u0627\u0644\u0629 \u0645\u0646 \u0627\u0644\u0645\u0641\u0636\u0644\u0629', 'Remove from favorites') : t('\u0625\u0636\u0627\u0641\u0629 \u0644\u0644\u0645\u0641\u0636\u0644\u0629', 'Add to favorites')}
        >
          <svg
            width="14"
            height="14"
          ...
          <div className="px-3 pb-3 border-t border-[var(--bg-input)] space-y-2">
            ...
            <div className="flex items-center gap-2 pt-1">
              ...
              >
                ...
                {copied ? t('\u062A\u0645 \u0627\u0644\u0646\u0633\u062E!', 'Copied!') : t('\u0646\u0633\u062E SQL', 'Copy SQL')}
              </button>
